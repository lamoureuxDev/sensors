...
The Sensor Simulator program is a UI, designed to set random sensors values in a shared memory. Values are setted every second by default with a different fixed range for each type of sensor.

This program is intended to simulate real sensors, sending data. Use it only for testing purpose, alongside a sensor\+\_\+alert and/or a sensor\+\_\+stat to read simulated values.

A shared memory is used to communicate between processes and share sensors data. Sensor\+\_\+simulator use the shared memory only in writting mode.
...
\DoxyCodeLine{\$\ qmake}
\DoxyCodeLine{\$\ make}
\DoxyCodeLine{\$\ ./sensor\_simulator}
...
\DoxyCodeLine{\$\ sudo\ chmod\ +x\ /usr/bin/sensor\_simulator}
...
Following theses steps, sensor\+\_\+simulator program will run automaticaly on boot, along side the sensor\+\_\+stat and sensor\+\_\+alerts, with the sensor\+\_\+simulator launched fisrt.\doxysubsection{Yocto}\label{index_Yocto}
...
To populate our recipe for sensor-\/stats, we will import our source files in our recipe to get this architecture\+: (assuming that \$\+BUILD\+\_\+\+SENSOR\+\_\+\+SIMU= /path/to/sensor\+\_\+stats\+\_\+sources)


\begin{DoxyCode}{0}
\DoxyCodeLine{../poky/buils\$\ bitbake-\/layers\ create-\/layer\ ../meta-\/sensors}
\DoxyCodeLine{../poky/buils\$\ cd\ ../meta-\/sensors}
\DoxyCodeLine{../poky/meta-\/sensors\$\ mv\ recipes-\/example\ recipes-\/sensor-\/simu}
\DoxyCodeLine{../poky/meta-\/sensors\$\ mkdir\ recipes-\/sensor-\/simu/sensor-\/simu}
\DoxyCodeLine{../poky/meta-\/sensors\$\ mkdir\ recipes-\/sensor-\/simu/sensor-\/simu/files}
\DoxyCodeLine{../poky/meta-\/sensors\$\ cp\ \$BUILD\_SENSOR\_SIMU\textcolor{comment}{/*.*\ recipes-\/sensor-\/stats/sensor-\/simu/files/}}
\DoxyCodeLine{\textcolor{comment}{...poky/meta-\/sensors\$\ tree\ recipes-\/sensor-\/simu/\ -\/L\ 3}}
\DoxyCodeLine{\textcolor{comment}{recipes-\/sensor-\/simu/}}
\DoxyCodeLine{\textcolor{comment}{└──\ sensor-\/simu}}
...
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ │\ \ \ ├──\ sensor\_simu.pro}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{SUMMARY\ =\ \textcolor{stringliteral}{"{}My\ Sensor\ Simu\ application"{}}}
...
\DoxyCodeLine{\textcolor{stringliteral}{\ \ \ \ \ \ \ \ \ \ \ file://sensor\_simu.pro\ \(\backslash\)"{}}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
\DoxyCodeLine{\textcolor{stringliteral}{S\ =\ "{}}\$\{WORKDIR\}\textcolor{stringliteral}{"{}}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
\DoxyCodeLine{\textcolor{stringliteral}{require\ recipes-\/qt/qt5/qt5.inc}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
\DoxyCodeLine{\textcolor{stringliteral}{DEPENDS\ +=\ "{}}qtbase\textcolor{stringliteral}{"{}}}
\DoxyCodeLine{\textcolor{stringliteral}{inherit\ qmake5}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
\DoxyCodeLine{\textcolor{stringliteral}{\#COMPILE\ MYIN\ THE\ DATADIR\ OF\ THE\ IMAGE,}}
\DoxyCodeLine{\textcolor{stringliteral}{do\_install()\ \{}}
\DoxyCodeLine{\textcolor{stringliteral}{\ \ \ \ install\ -\/d\ \$\{D\}\$\{datadir\}/\$\{P\}}}
\DoxyCodeLine{\textcolor{stringliteral}{\ \ \ \ install\ -\/m\ 0755\ \$\{S\}/sensor-\/stats\ \$\{D\}\$\{datadir\}/\$\{P\}}}
\DoxyCodeLine{\textcolor{stringliteral}{\ \ \ \ cp\ -\/R\ -\/-\/no-\/dereference\ -\/-\/preserve=mode,links\ \$\{S\}\ \$\{D\}\$\{datadir\}/\$\{P\}}}
\DoxyCodeLine{\textcolor{stringliteral}{\}}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
\DoxyCodeLine{\textcolor{stringliteral}{FILES\_\$\{PN\}\ +=\ "{}}\$\{datadir\}\textcolor{stringliteral}{"{}}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
\DoxyCodeLine{\textcolor{stringliteral}{RDEPENDS\_\$\{PN\}\ =\ "{}}qtbase\ qtcore\textcolor{stringliteral}{"{}}}
