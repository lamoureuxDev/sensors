...
The Sensor Alerts program is a UI, designed to display sensors statistics values such as :
 - average
 - minimum
 - maximum
...
```
 ...
 Following theses steps, Sensor_alerts program will run automaticaly on boot, along side the sensor_simulator and Sensor_alerts, with the sensor_simulator launched fisrt.
